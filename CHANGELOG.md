...
* Implement drag-and-drop functionality for notice cards. Refs UICIRC-1372.
* Add plus icon for adding a notice above the current notice. Refs UICIRC-1355.
...
* CheckoutSettings: highlight already selected custom fields. Remove custom field from the selection after clicking on it. Fixes UICIRC-1333.
* Debounce patron notice template name validation to reduce excessive HTTP requests. Refs UICIRC-1341.

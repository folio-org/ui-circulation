...
describe('PatronNoticePrintJobs', () => {
  ...
  it('renders data', async () => {
    const { container } = render(<PatronNoticePrintJobs mutator={mockMutator} resources={mockResources} />);
    expect(container).toHaveTextContent('2022-01-01');
  });

  it('calls openPDF', async () => {
    render(<PatronNoticePrintJobs mutator={mockMutator} resources={mockResources} />);
